  ...
  learningos: [
    ...
    },
    {
      ...
      features: [
        ...
        "Génération avancée de parcours adaptatifs",
    ...
    {
      name: "Enterprise",
      description: "Pour construire une véritable infrastructure de formation autonome et adaptative.",
      monthlyPrice: null,
      yearlyPrice: null,
      originalPrice: null,
      setupFee: 15000,
      ...
      features: [
        "Tout Growth",
        "Générateur de badges et référentiels internes",
        ...
        "Audit Qualiopi et accompagnement conformité",
      ],
...
export const FALLBACK_PLANS_EN: Record<string, PricingPlan[]> = {
  learningos: [
    ...
    {
      name: "Enterprise",
      description: "Build a truly autonomous and adaptive training infrastructure.",
      ...
      features: [
        "All Growth features",
        "Badge and internal framework generator",
