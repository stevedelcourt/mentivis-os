...
interface ImpactSectionClientProps {
  lang: Locale;
  initialPosts: Post[];
}
...
export default function ImpactSectionClient({ lang, initialPosts }: ImpactSectionClientProps) {
  const t = getT(lang);
          ...
          <div className="impact-stack" style={{ minHeight: 320 }}>
            <style>{`
              ...
              @media (max-width: 768px) {
                ...
                .impact-card, .impact-empty { grid-column: auto !important; grid-row: auto !important; aspect-ratio: 2/1 !important; padding: 14px 16px !important; }
