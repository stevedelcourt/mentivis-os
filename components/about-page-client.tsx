...
export default function AboutPageClient({ lang }: AboutPageProps) {
  ...
  const H = isFr ? {
    ...
    convictionText: "Training is not a cost. It is a value production system.",
    convictionAuthor: "Steven Delcourt, Founder, Mentivis",
    histoireTitle: "Born from operational experience",
    histoireBody1: "Mentivis's founders have already built schools together. Pedagogy, business development, marketing, compliance, operations. Every dimension of the profession.",
    histoireBody2: "They joined forces for one precise reason. The rapid changes in education and training demand a specialized player capable of bridging companies, training systems, and future challenges.",
