...
const TEAM = [
  ...
  },
  {
    ...
    img: "/images/team/julie-steiner.webp",
  },
  {
...
export default function AboutPageClient({ lang }: AboutPageProps) {
  ...
  const H = isFr ? {
    ...
    ctaTitle: "Un projet de formation a structurer ?",
    ctaBody: "Premier echange sans engagement, analyse de votre besoin et positionnement clair sur notre capacite a vous accompagner.",
    ctaPrimary: "Demarrer gratuitement",
    ctaSecondary: "Contacter l'equipe",
  } : {
    heroEyebrow: "About",
    heroHeadline: "MentivisOS is the AI-native training system built by Mentivis",
    heroSub: "From strategy to operational deployment. A single OS to train, certify and grow talent.",
    convictionText: "Training is not a cost. It's a value production system.",
    convictionAuthor: "Steven Delcourt — Founder, Mentivis",
    histoireTitle: "Born from operational experience",
    histoireBody1: "Mentivis's founders have built schools together before. Pedagogy, business development, marketing, compliance, operations. Every dimension of the craft.",
    histoireBody2: "They joined forces for one specific reason. The rapid changes in education and training demand a specialized player, capable of bridging companies, training systems and future challenges.",
    histoireBody3: "A choice from the start. Not abstract consulting, but building systems that actually work.",
    equipeTitle: "The team",
    equipeSub: "Four partners.",
