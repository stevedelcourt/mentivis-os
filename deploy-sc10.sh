...
# ── Configuration ──
SSH_KEY="${DEPLOY_SSH_KEY:-/Users/stv/Documents/zed/DeployOS-sc10/id_rsa_sc10}"
SSH_HOST="${DEPLOY_SSH_HOST:-terre.o2switch.net}"
SSH_USER="${DEPLOY_SSH_USER:-sc10bovu7233}"
...
echo "=== Deploying to sc10 (${LIVE_URL}) ==="
...
SITE_URL=https://sc10bovu7233.universe.wf
