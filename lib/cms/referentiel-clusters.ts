...
export const CLUSTERS: Record<PilierSlug, string[]> = {
  "pilier-conformite-et-formation-ia-ai-act": [
    ...
    "ai-act-article-4-ce-que-votre-entreprise-doit-mettre-en-place",
    ...
    "entretien-professionnel-risques-pour-l-employeur-en-cas-de-non-conformite",
    "rgpd-et-formation-ce-que-les-drh-doivent-savoir-sur-les-donnees-des-apprenants",
  ],
  "pilier-mesure-des-competences": [
    ...
    "que-mesurer-lors-d-un-entretien-professionnel",
    "l-obsolescence-des-competences-comment-savoir-si-votre-equipe-est-a-risque",
    "competences-les-plus-rares-en-france-en-2026-et-comment-les-developper",
    "comment-mesurer-le-roi-d-un-plan-de-formation",
    ...
    "roi-de-la-formation-par-secteur-ce-que-disent-les-donnees",
  ...
  "pilier-au-dela-du-lms": [
    ...
    "mon-lms-ne-sert-a-rien-pourquoi-les-taux-de-completion-s-effondrent",
    ...
    "ingenierie-pedagogique-pourquoi-la-plupart-des-formations-ne-marchent-pas",
    "comment-batir-une-politique-de-formation-alignee-sur-la-strategie-d-entreprise",
    "organisation-apprenante-ce-que-cela-implique-pour-les-drh",
  ],
  "pilier-apprentissage-adaptatif-personnalisation": [
    ...
    "formation-intensive-ou-etalee-que-dit-la-science-de-l-apprentissage",
  ],
};
