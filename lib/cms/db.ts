...
const DEFAULT_PRICING_EN: PricingContent = {
  ...
  pipelineos: [
    ...
    {
      name: "Growth",
      description: "AI matching, scoring, multi-recruiter, candidate portal, advanced automations, HR analytics, LearningOS onboarding sync.",
