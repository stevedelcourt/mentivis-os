...
const DEFAULT_HERO_FR: Record<string, HeroContent> = {
  ...
  talentos: {
    ...
    subheadline: "ATS intelligent, matching de profils, tests & cas pratiques, et pilotage de vos recrutements, le tout dans un seul système connecte a vos outils RH.",
    ctaPrimary: "Demarrer gratuitement",
    ctaPrimaryLink: "https://app.mentivisOS.com",
    ctaSecondary: "Contacter l'équipe",
    ctaSecondaryLink: "/contact",
  ...
  about: {
    eyebrow: "A propos",
    headline: "MentivisOS est le système de formation native IA conçu par Mentivis",
    subheadline: "De la stratégie au déploiement opérationnel. Un seul OS pour former, certifier et faire grandir les talents.",
    ctaPrimary: "",
    ctaPrimaryLink: "",
    ctaSecondary: "",
    ctaSecondaryLink: "",
  ...
  security: {
    eyebrow: "Securite",
    headline: "L'IA pédagogique pour transformer la formation,\navec confidentialite et protections intégrées.",
    subheadline: "",
    ctaPrimary: "",
    ctaPrimaryLink: "",
    ctaSecondary: "",
  ...
  ambassadors: {
    ...
    subheadline: "Un programme conçu pour les professionnels de la formation, du recrutement et du conseil qui souhaitent recommander MentivisOS a leur reseau.",
    ctaPrimary: "Rejoindre le programme",
    ctaPrimaryLink: "/contact",
    ctaSecondary: "Demander une présentation",
...
const DEFAULT_HERO_EN: Record<string, HeroContent> = {
  ...
  ambassadors: {
    ...
    ctaPrimaryLink: "/contact",
    ctaSecondary: "Request a présentation",
    ctaSecondaryLink: "/demo",
    proof: "",
  },
};
...
const DEFAULT_PRICING: PricingContent = {
  learningos: [
    ...
    },
    {
      ...
      features: [
        "Tout Growth",
        "Generateur de certifications et référentiels internes",
...
const DEFAULT_PRICING_EN: PricingContent = {
  learningos: [
    { name: "Starter", description: "AI-driven internal academy.", monthlyPrice: null, yearlyPrice: null, originalPrice: null, setupFee: null, cta: "Contact us", ctaLink: "/contact", gradient: "var(--module-grad-2)", previousPlan: null, features: ["Auto-generated personalized training paths", "Content adaptation based on your roles and frameworks", "Conversational AI agents for employee support", "Real-time skills and progress tracking", "Secure enterprise workspace", "Rapid deployment without internal pedagogical team", "OPCO funding compatible"], creditLimit: "Custom", popular: false },
    { name: "Growth", description: "Scale up your team's skills.", monthlyPrice: null, yearlyPrice: null, originalPrice: null, setupFee: null, cta: "Contact us", ctaLink: "/contact", gradient: "var(--module-grad-3)", previousPlan: null, features: ["All Starter features", "Advanced certified program generation", "Automatic adaptation by role, level and objective", "AI-powered dynamic business library", "HR and skills dashboards", "Managerial validation workflows", "Compliance reporting and training traceability", "Public funding and OPCO application assistance", "API and HRIS integrations"], creditLimit: "Custom", popular: false },
    { name: "Enterprise", description: "Full autonomous training infrastructure.", monthlyPrice: null, yearlyPrice: null, originalPrice: null, setupFee: null, cta: "Contact us", ctaLink: "/contact", gradient: "var(--module-grad-4)", previousPlan: null, features: ["All Growth features", "Certification and internal framework generator", "Proprietary pedagogical model adapted to your roles", "Dedicated pedagogical engineering and ongoing support", "Advanced HRIS, LMS, CRM integrations", "Multi-site and multi-country deployment", "Guaranteed SLA and priority support", "GDPR, ISO 27001, accessibility compliance", "Qualiopi audit and certification support"], creditLimit: "Custom", popular: false },
  ],
  pipelineos: [
    { name: "Starter", description: "ATS, candidate pipelines, basic matching, HR dashboard.", monthlyPrice: null, yearlyPrice: null, originalPrice: null, setupFee: null, cta: "Contact us", ctaLink: "/contact", gradient: "var(--module-grad-2)", previousPlan: null, features: ["Complete ATS", "Candidate pipelines", "Basic matching", "HR dashboard", "Recruitment workflows", "Basic automations"], creditLimit: "Custom", popular: false },
    { name: "Growth", description: "AI matching, scoring, multi-recruiter, HR analytics.", monthlyPrice: null, yearlyPrice: null, originalPrice: null, setupFee: null, cta: "Contact us", ctaLink: "/contact", gradient: "var(--module-grad-3)", previousPlan: null, features: ["Advanced AI matching", "Candidate scoring", "Multi-recruiter", "Candidate portal", "Advanced automations", "HR analytics", "LearningOS onboarding sync"], creditLimit: "Custom", popular: false },
    { name: "Enterprise", description: "Dedicated architecture, private deployment.", monthlyPrice: null, yearlyPrice: null, originalPrice: null, setupFee: null, cta: "Contact us", ctaLink: "/contact", gradient: "var(--module-grad-4)", previousPlan: null, features: ["Dedicated infrastructure", "Private deployment", "AI orchestration", "Governance", "Compliance", "Audit logs", "Advanced API access"], creditLimit: "Custom", popular: false },
  ],
  api: [
    { name: "Starter", description: "500k requests, auth, workflows, embeddings, basic analytics.", monthlyPrice: null, yearlyPrice: null, originalPrice: null, setupFee: null, cta: "Contact us", ctaLink: "/contact", gradient: "var(--module-grad-1)", previousPlan: null, features: ["500k requests", "Auth", "Workflows", "Embeddings", "Basic analytics"], creditLimit: "Custom", popular: false },
    { name: "Build", description: "2M requests, webhooks, custom models, advanced analytics.", monthlyPrice: null, yearlyPrice: null, originalPrice: null, setupFee: null, cta: "Contact us", ctaLink: "/contact", gradient: "var(--module-grad-2)", previousPlan: null, features: ["2M requests", "Webhooks", "Custom models", "Advanced analytics", "Priority support"], creditLimit: "Custom", popular: false },
    { name: "Scale", description: "10M requests, agent orchestration, monitoring.", monthlyPrice: null, yearlyPrice: null, originalPrice: null, setupFee: null, cta: "Contact us", ctaLink: "/contact", gradient: "var(--module-grad-3)", previousPlan: null, features: ["10M requests", "Agent orchestration", "Multi-workspaces", "Monitoring", "Observability", "Priority support"], creditLimit: "Custom", popular: false },
    { name: "Enterprise", description: "Dedicated infrastructure, SLA, private deployment.", monthlyPrice: null, yearlyPrice: null, originalPrice: null, setupFee: null, cta: "Contact us", ctaLink: "/contact", gradient: "var(--module-grad-4)", previousPlan: null, features: ["Dedicated infrastructure", "SLA", "Private deployment", "AI orchestration", "Governance", "Compliance", "Audit logs", "Advanced API access"], creditLimit: "Custom", popular: false },
  ],
};
...
export async function getPricing(lang: "fr" | "en" = "fr"): Promise<PricingContent> {
  ...
  try {
    ...
    const merged: PricingContent = { learningos: defaults.learningos, pipelineos: defaults.pipelineos, api: defaults.api };
    for (const row of rows) {
      const product = row.product as keyof PricingContent;
      if (merged[product]) {
        try { merged[product] = JSON.parse(row.plans_json); } catch {}
      }
    }
    return merged;
  } catch {
